                ...
                <table id="table-show" class="table table-bordered table-striped" style="font-size: 15px;">
                    ...
                    <tbody class="text-capitalize">
                        ...
                        <tr>
                            ...
                            <td class="pt-3">{{ $row->nama_penyedia }}</td>
                            <td class="text-center">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item btn" type="button" href="#">
                                        <i class="fas fa-users"></i> Pegawai
                                    </a>
                                    <a class="dropdown-item btn" type="button" href="{{ route('penyedia.edit', $row->id_penyedia) }}">
                                        <i class="fas fa-edit"></i> Edit
                                    </a>
                                    <a class="dropdown-item btn" type="button" href="{{ route('penyedia.delete', $row->id_penyedia) }}" onclick="return confirm('Ingin Menghapus Data?')">
