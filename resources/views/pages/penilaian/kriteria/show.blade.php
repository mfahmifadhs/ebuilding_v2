                ...
                <table id="table-show" class="table table-bordered table-striped" style="font-size: 15px;">
                    ...
                    <tbody class="text-capitalize">
                        ...
                        <tr>
                            ...
                            <td class="pt-3">{{ $row->nama_kriteria }}</td>
                            <td class="text-center">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item btn" type="button" href="{{ route('kriteria.edit', $row->id_kriteria) }}">
                                        <i class="fas fa-edit"></i> Edit
                                    </a>
                                    <a class="dropdown-item btn" type="button" href="{{ route('kriteria.delete', $row->id_kriteria) }}" onclick="return confirm('Ingin Menghapus Data?')">
