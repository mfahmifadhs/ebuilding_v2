                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item btn" type="button" href="{{ route('gedung.edit', $row->id_gedung) }}">
                                        <i class="fas fa-edit"></i> Edit
                                    </a>
                                    <a class="dropdown-item btn" type="button" href="{{ route('gedung.delete', $row->id_gedung) }}" onclick="return confirm('Ingin Menghapus Data?')">
